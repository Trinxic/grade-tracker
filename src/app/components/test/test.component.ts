...
import { Service, FileSystemItem } from "./test.service";
...
export class AppComponent {
  ...
  calculateToIndex(
    e: DxSortableTypes.DragEndEvent | DxSortableTypes.DragChangeEvent,
  ) {
...
@NgModule({
  imports: [BrowserModule, DxTreeViewModule, DxSortableModule],
